...
/** CUP v0.10k generated parser.
  * @version Mon Sep 12 16:27:02 EDT 2005
  */
public class Grm
  ...
  public final java_cup.runtime.Symbol CUP$Grm$do_action_0(
    ...
    RESULT = new TypedList(new LinkedList(), Formal.class, false); 
		...
		ClassBody d = (ClassBody)((java_cup.runtime.Symbol) CUP$Grm$stack.elementAt(CUP$Grm$top-0)).value;
                                                                                    ...
                                                                                    List l = new TypedList(new LinkedList(), ClassMember.class, false);
           l.add(parser.nf.JL5ClassDecl(parser.pos(n, d), a.classicFlags(JL5Flags.ENUM), b.getIdentifier(),  parser.nf.CanonicalTypeNode(parser.pos(n,d), parser.ts.Enum()), c, d));
           RESULT = l; 
